                ...
                <SwiperSlide>
                    <section className="p-6 dark:text-blue-400 bg-gray-50 rounded-b-md">
                        <div className=" grid gap-6 mx-auto text-center lg:grid-cols-2 xl:grid-cols-5">
                            ...
                            <img src="https://i.ibb.co/KNsHR9F/2942054-408406-PDZ1-KL-914.jpg" className="object-cover h-[28vh] lg:h-[70vh] w-full rounded-md xl:col-span-3 bg-gray-500" />
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide>
                    <section className="p-6 dark:text-blue-400 bg-lime-50 rounded-b-md">
                        <div className="container grid gap-6 mx-auto text-center lg:grid-cols-2 xl:grid-cols-5">
                            <div className="w-full sm:space-y-2 lg:px-6 lg:py-16 rounded-md sm:px-12 md:px-16 xl:col-span-2 ">
                                ...
                                <h1 className="text-2xl lg:text-4xl font-extrabold">Explore Diverse Volunteer Opportunities</h1>
                                <p className="lg:my-4">
                            ...
                            <img src="https://i.ibb.co/XL2DG9X/7788663-3735515.jpg" alt="" className="object-cover  h-[28vh] lg:h-[70vh] w-full rounded-md xl:col-span-3 bg-gray-500" />
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide>
                    <section className="p-6 dark:text-gray-100 bg-[#01CDD4] rounded-b-md">
                        <div className="container grid gap-6 mx-auto text-center lg:grid-cols-2 xl:grid-cols-5">
                            <div className="w-full sm:space-y-2 lg:px-6 lg:py-16 rounded-md sm:px-12 md:px-16 xl:col-span-2 ">
                                ...
                                <h1 className="text-2xl lg:text-4xl font-extrabold">See the Impact of Your Contribution</h1>
                                <p className="lg:my-4">
                            ...
                            <img src="https://i.ibb.co/RyT165T/2546573-356309-PAXG83-360.jpg" alt="" className="object-cover  h-[28vh] lg:h-[70vh] w-full rounded-md xl:col-span-3 bg-gray-500" />
                        </div>
                    </section>
                </SwiperSlide>
                <SwiperSlide>
                    <section className="p-6 dark:text-gray-100 bg-[#27A8E1] rounded-b-md">
                        <div className="container grid gap-6 mx-auto text-center lg:grid-cols-2 xl:grid-cols-5">
                            ...
                            <img src="https://i.ibb.co/QQQxNTY/1853167-253000-P4-NDBU-283.jpg" alt="" className="object-cover w-full  h-[28vh] lg:h-[70vh]  rounded-md xl:col-span-3 bg-gray-500" />
                        </div>
                    </section>
                </SwiperSlide>
